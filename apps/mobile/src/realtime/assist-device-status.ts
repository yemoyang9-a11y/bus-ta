...
export function getAssistDeviceFallbackMessage(
  ...
  return event.attempts ? `지팡이 연결을 ${event.attempts}회 시도했지만 연결하지 못해 버스 접근 진동을 사용할 수 없습니다.` : "지팡이에 연결하지 못해 버스 접근 진동을 사용할 수 없습니다.";
}
