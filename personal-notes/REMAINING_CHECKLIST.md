...
> **2026-09-22:** 아래 체크박스는 옛 기준 커밋의 기록이다. 운행 취소, 실모듈 연동, 1551 fixture, 탑승확정·GPS RPC, 실제 비콘 등록 등은 후속 코드로 대체됐다. 현재 남은 항목은 [통합 실행 계획](../docs/superpowers/plans/2026-09-22-rehearsal-backlog.md)과 [실행 결과](../docs/superpowers/plans/2026-09-22-rehearsal-results.md)를 기준으로 한다. 과거 완료 기록을 최신 실기기 검증 성공으로 해석하지 않는다. 옛 worktree·사용자 변경은 이번 작업에서 삭제하지 않는다.
